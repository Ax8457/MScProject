...
SYMBOL_CRC(handshake_consume_initiation, 0xc4a04a18, "");
SYMBOL_CRC(handshake_create_response, 0x25721603, "");
SYMBOL_CRC(handshake_consume_response, 0x8583632f, "");
SYMBOL_CRC(begin_session, 0x1d2df5a7, "");
...
MODULE_INFO(srcversion, "102705420D49EEC1279BB46");
