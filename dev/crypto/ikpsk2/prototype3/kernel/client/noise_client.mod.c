...
__used __section("__versions") = {
	...
	{ 0x92997ed8, "_printk" },
	{ 0x6947bd0d, "g_bridge" },
	{ 0xa467db1f, "noise_handshake_create_initiation" },
	{ 0xcf2a6966, "up" },
	{ 0x6bd0e573, "down_interruptible" },
	{ 0x8583632f, "handshake_consume_response" },
	{ 0x1d2df5a7, "begin_session" },
...
MODULE_INFO(depends, "libcurve25519-generic,curve25519-x86_64,noise_server,ikpsk2_crypto");
